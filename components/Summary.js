...
const Summary = () => {
  return (
    <div className='pt-10 '>
        <div className='grid-col pb-20'>
            <h1 className='max-[1112px]:text-5xl text-8xl font-bold'>Asaad Al-Awami</h1>
            <h4 className='text-xl max-[840px]:grid grid-rows-3'> <span> | Dammam (willing to relocate)</span><span> | M: +966 547609964</span> <span> | assadawami2022@gmail.com</span> </h4>
        </div>
